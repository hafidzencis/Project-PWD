            ...
            <div class="col-xl-12 col-lg-7 mb-4">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a class="m-0 float-right btn btn-danger btn-sm" href="addadmin.php">Add Admin
                ...
                <div class="table-responsive">
                  <table class="table  align-items-center table-flush">
                    ...
                    <tbody>
                        <?php 
                            $num = 1;
                            $result = query("SELECT * FROM login WHERE role = 'Admin'");
                      ...
                      <tr>
                        ...
                        <a href="deleteadmin.php?id=<?= $dat['iduser']?>" onclick="return confirm('Yakin Data Dihapus?');" class="btn btn-sm btn-danger">Delete</a> 
