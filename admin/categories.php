            ...
            <div class="col-xl-12 col-lg-7 mb-4">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a class="m-0 float-right btn btn-danger btn-sm" href="addcategory.php">Add Categories <i
                ...
                <div class="table-responsive">
                  <table class="table  align-items-center table-flush">
                    ...
                    <tbody>
                        ...
                        while ($fetchcategory = mysqli_fetch_assoc($result)) { ?>
                            
                      <tr>
                        <td><?= $num?></td>
                        <td><?= $fetchcategory['nama_kategori'] ?></td>
                        <td><div class="d-flex  mr-4">
                        <a href="editcategory.php?id=<?= $fetchcategory['idkategori']?>"  class="btn btn-sm btn-primary">Update</a> &nbsp;
                        <a href="deletecategory.php?id=<?= $fetchcategory['idkategori']?>" onclick="return confirm('Yakin Data Dihapus?');" class="btn btn-sm btn-danger">Delete</a> 
