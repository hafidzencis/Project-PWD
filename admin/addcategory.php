...
if (isset($_POST['submit'])) {
  ...
  $result = mysqli_query($conn,"INSERT INTO kategori_produk (idkategori,nama_kategori) VALUES ('','$namecategory')");
  if (mysqli_affected_rows($conn) > 0) {
    echo "<script> alert('Success adding category');
      document.location.href='categories.php';
    </script> ";
  } else {
    "<script> alert('Fail adding category')
