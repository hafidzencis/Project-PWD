            ...
            <div class="col-xl-12 col-lg-7 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <a class="m-0 float-right btn btn-danger btn-sm" href="printpurchasing.php">Print <i class="fas fa-chevron-right"></i></a>
                </div>
                  ...
                  <table class="table  align-items-center table-flush">
                    ...
                    <tbody>
                        <?php 
                            $num = 1;
                            $total = 0;
                            $result = queryitem("SELECT * FROM pembelian JOIN login ON pembelian.iduser = login.iduser");
                      ...
                      <tr>
                        ...
                        <?php $total = $total + $fetchcostumer['total_pembelian']?>
                        <td><div class="d-flex  mr-4"><a href="detailpurchasing.php?id=<?=$fetchcostumer['idpembelian'] ?>" class="btn btn-sm btn-primary">Detail</a>
                        &nbsp; 
                        ...
                        <?php
                            if ($fetchcostumer['status'] == 'Already paid' or $fetchcostumer['status'] == 'Product is on the way' or $fetchcostumer['status'] == 'Product has been shipped'  ) { ?>
                                <a href="resi.php?id=<?=$fetchcostumer['idpembelian'] ?>"  class="btn btn-sm btn-info"> Info Purchase </a> </div></td> 
                            <?php }
                            elseif ($fetchcostumer['status'] == 'Product has arrived' and empty($cekbuktifoto['buktifoto']) ) { ?>
                              <a href="resi.php?id=<?=$fetchcostumer['idpembelian'] ?>"  class="btn btn-sm btn-warning"> Product has arrived </a> &nbsp;
                              <a href="evidencephoto.php?id=<?=$fetchcostumer['idpembelian'] ?>"  class="btn btn-sm btn-success"> Evidence Photo </a> </div></td> 
                            <?php } ?>
                            <?php $num++?>
                        <?php }  ?>
                      </tr>
