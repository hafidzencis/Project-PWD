        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <?php foreach ($categories as $data) { ?>     
                        <li class="pb-3">
                        <a  class="text-success d-flex justify-content-between h3 text-decoration-none " href="categoryshop.php?id=<?=$data['idkategori'] ?>">
                         <?=$data['nama_kategori']?>
                        </a>
                    </li>     
                    <?php } ?>
            ...
            <div class="col-lg-9">
                <div class="row">
                <?php  $product = query("SELECT * FROM Produk ") ;
                                 foreach ($product as $data) { ?>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                               <a href="shop-single.php?id=<?= $data['idproduk']?>"> <img width="150px" height="100px"  class="card-img rounded-0 img-fluid" src="img/<?= $data['fotoproduk'] ?>" > </a>
                            </div>
                            <div class="card-body">
            ...
            <div class="row text-light mb-4">
                ...
                <div class="d-flex justify-content-center mr-5">
                    <ul class="d-flex justify-content-center p-2 list-unstyled ">
                        ...
                        <li class="list-inline-item border border-light rounded-circle text-center mx-5">
                            <a class="text-light text-decoration-none" target="_blank" href="https://twitter.com/hafidzencis"><i class="fab fa-twitter fa-lg fa-fw"></i></a>
                        </li>
                        <li class="list-inline-item border border-light rounded-circle text-center mx-5">
                            <a class="text-light text-decoration-none" target="_blank" href="https://www.linkedin.com/in/muhammad-hafidz-febriansyah-77846a202/"><i class="fab fa-linkedin fa-lg fa-fw"></i></a>
                        </li>
                    </ul>
                </div>
