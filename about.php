...
<body>
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <form action="search.php" method="get">    
                        <div class="d-flex">
                            ...
                            <input type="text" name="keyword" class="form-control" placeholder="Shoes...."> 
        ...
        <div class="container py-5">
            <div class="row align-items-center py-5">
                <div class=" text-success py-5">
                    <h1 >Hobby Fish Shop</h1> <br>
                    <h1 class="h1"> Get Rid Of Selfish With Some Fish </h1>
    ...
    <!-- Start Footer -->
    <footer class="bg-dark py-5" id="tempaltemo_footer">
